...
var findAllCompanies = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, comapny_model_1.Company.find()];
            case 1:
                allCompany = _a.sent();
...
var findEmailByCompany = function (email) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, comapny_model_1.Company.findOne({ email: email })];
            case 1:
                company = _a.sent();
                return [2 /*return*/, company];
            case 2:
...
var findCompanyById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, comapny_model_1.Company.findById(id)];
            case 1:
                company = _a.sent();
                return [2 /*return*/, company];
            case 2:
