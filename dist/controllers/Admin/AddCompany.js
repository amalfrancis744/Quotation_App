...
exports.deleteCompany = exports.updateCompany = exports.getCompany = exports.createCompany = exports.getAllCompanies = void 0;
...
// List all companies
var getAllCompanies = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var adminId, companies, error_1;
...
var createCompany = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var adminId, _a, companyName, alias, addresses, accountDetails, website, email, mobileNo, state, existsCompany, checkEmail, company, error_2;
...
var getCompany = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var adminId, company_id, result, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
...
var updateCompany = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var adminId, company_id, _a, companyName, alias, addresses, accountDetails, website, email, mobileNo, state, existingCompany, normalizedEmail, emailExistes, companyExits, updateData, updatedData, error_4;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 7, , 8]);
            ...
            case 1:
                ...
                return [4 /*yield*/, companyRepository.findEmailByEmailCompanyId(normalizedEmail, company_id)];
            case 2:
            ...
            case 3:
                ...
                return [4 /*yield*/, companyRepository.findCompayByCompanyNameAndSame(companyName, company_id)];
            case 4:
            ...
            case 5:
                ...
                return [4 /*yield*/, companyRepository.findByIdAndUpdate(company_id, updateData)];
            case 6:
                updatedData = _b.sent();
                if (!updatedData) {
                    return [2 /*return*/, response_1.GlobleResponse.error({
...
var deleteCompany = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var adminId, company_id, existingCompany, deleteCompany_1, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
