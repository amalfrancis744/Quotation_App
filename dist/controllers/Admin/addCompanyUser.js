...
var AddCompanyUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, firstName, lastName, email, password, companyId, existingUser, existingCompany, existingCompanyUser, salt, hashedPassword, newUser, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 7, , 8]);
                _a = req.body, firstName = _a.firstName, lastName = _a.lastName, email = _a.email, password = _a.password, companyId = _a.companyId;
                // Check for missing credentials
                if (!firstName || !lastName || !email || !password || !companyId) {
                    return [2 /*return*/, response_1.GlobleResponse.error({
                            res: res,
                            status: http_status_1.default.BAD_REQUEST,
                            msg: constant_1.ERROR_MSGS.INVALID_CREDETIALS,
                        })];
                }
            ...
            case 2:
                ...
                return [4 /*yield*/, userRespository.findUserByCompanyId(companyId)];
            case 3:
