            ...
            case 1:
                ...
                if (existingAdmin) {
                    return [2 /*return*/, response_1.GlobleResponse.error({
                            ...
                            msg: constant_1.ERROR_MSGS.USERNAME_EXITS,
                        })];
                }
...
var loginAdmin = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, password, admin, isMatch, SCERET_KEY, token, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 3, , 4]);
            ...
            case 2:
                ...
                SCERET_KEY = process.env.ADMIN_JWT_SECRET || "mysceretkey";
                token = jsonwebtoken_1.default.sign({ adminId: admin._id }, SCERET_KEY, {
                    expiresIn: "1h",
                });
