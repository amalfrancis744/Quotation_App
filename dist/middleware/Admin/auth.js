...
var adminAuthMiddleware = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var authHeader, token, SCERET_KEY, decoded, admin, err_1, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                SCERET_KEY = process.env.ADMIN_JWT_SECRET;
                decoded = jsonwebtoken_1.default.verify(token, SCERET_KEY);
                return [4 /*yield*/, adminRepository.findAdminById(decoded.adminId)];
            case 2:
                admin = _a.sent();
                if (!admin) {
                    return [2 /*return*/, response_1.GlobleResponse.error({
